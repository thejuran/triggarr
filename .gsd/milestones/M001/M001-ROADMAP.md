...
- [x] **S07: Web UI Integration** `risk:high` `depends:[S06]`
  > After this: Users can view per-instance status cards, filter search history by instance, and see version info — all from the web UI.
