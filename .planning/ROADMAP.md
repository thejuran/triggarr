...
**Goal:** Fix skip badge math bug (unmonitored items inflating unreleased count), improve settings template structure, and resolve deferred code quality findings
**Depends on:** Phase 27
**Requirements**: Code review findings (F1, F2, F4, M5, M6 from 28-RESEARCH.md)
**Plans:** 2/2 plans complete

Plans:
- [x] 28-01-PLAN.md -- Fix skip badge math (missing_monitored tracking) and INFO skip log
- [x] 28-02-PLAN.md -- Settings template wrapping and deferred code quality fixes (M5, M6)
...
| 28. Fix code review findings | v2.2 | 2/2 | Complete | 2026-03-09 |
