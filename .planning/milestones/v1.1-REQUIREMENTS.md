...
- [x] **RELS-01**: Push to main builds and pushes ghcr.io/thejuran/triggarr:dev
- [x] **RELS-02**: Git tag push builds and pushes ghcr.io/thejuran/triggarr:latest + version tag
