...
**Success Criteria** (what must be TRUE):
  1. Pushing to main builds and pushes ghcr.io/thejuran/triggarr:dev automatically
...
**Goal**: A new user can install and configure Triggarr from the README alone
**Depends on**: Phase 11 (screenshots capture final feature set)
**Requirements**: DOCS-01, DOCS-02, DOCS-03, DOCS-04
**Success Criteria** (what must be TRUE):
  1. README contains Docker pull command and a working docker-compose.yml example that a new user can copy-paste to run Triggarr
