...
- [x] **SRCH-01**: Triggarr fetches wanted (missing) items from Radarr
- [x] **SRCH-02**: Triggarr fetches cutoff unmet items from Radarr
- [x] **SRCH-03**: Triggarr fetches wanted (missing) items from Sonarr
- [x] **SRCH-04**: Triggarr fetches cutoff unmet items from Sonarr
- [x] **SRCH-05**: Triggarr cycles through items sequentially via round-robin, wrapping to start
...
- [x] **DEPL-01**: Triggarr runs as a Docker container with docker-compose support
