...
- [x] **SRCH-15**: Triggarr detects Sonarr v3 vs v4 API version at startup and logs it
- [x] **SRCH-16**: Triggarr logs total item count fetched per cycle so users can diagnose pageSize truncation
