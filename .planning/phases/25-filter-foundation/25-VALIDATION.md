...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 25-01-01 | 01 | 1 | CFG-02 | unit | `uv run pytest tests/test_config.py -x -q -k skip_unreleased` | No -- Wave 0 | ⬜ pending |
| 25-01-02 | 01 | 1 | FILT-01 | unit | `uv run pytest tests/test_search.py -x -q -k unreleased` | No -- Wave 0 | ⬜ pending |
| 25-01-03 | 01 | 1 | FILT-03 | unit | `uv run pytest tests/test_search.py -x -q -k null` | No -- Wave 0 | ⬜ pending |
| 25-01-04 | 01 | 1 | FILT-04 | unit | `uv run pytest tests/test_search.py -x -q -k unreleased` | No -- Wave 0 | ⬜ pending |
